export enum RPCCommands {
  ...
  CLOSE_ACTIVITY_JOIN_REQUES = "CLOSE_ACTIVITY_JOIN_REQUEST",
  ...
  BRAINTREE_POPUP_BRIDGE_CALLBAC = "BRAINTREE_POPUP_BRIDGE_CALL",
  ...
  DISCONNECT_FROM_LOBBY_VOIC = "DISCONNECT_FROM_LOBBY_VOICE",
  SET_OVERLAY_LOCKED = "SET_OVERLAY_LOCKED",
  OPEN_OVERLAY_ACTIVITY_INVIT = "OPEN_OVERLAY_ACTIVITY_INVITE",
  OPEN_OVERLAY_GUILD_INVITE = "OPEN_OVERLAY_GUILD_INVITE",
  OPEN_OVERLAY_VOICE_SETTING = "OPEN_OVERLAY_VOICE_SETTINGS",
